...
HD_PWD='C:/Users/Lab/Desktop/Gengchen_stuff/super_gaus_noise/super_gaus_noise.runs/super_mult_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log super_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source super_mult.tcl
