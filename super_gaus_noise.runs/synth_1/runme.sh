...
HD_PWD='C:/Users/Lab/Desktop/Gengchen_stuff/super_gaus_noise/super_gaus_noise.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gng_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gng_top.tcl
